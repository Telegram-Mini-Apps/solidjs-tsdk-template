...
➜  Local:   http://localhost:5173/solidjs-tsdk-template
➜  Network: http://172.18.16.1:5173/solidjs-tsdk-template
➜  Network: http://172.19.32.1:5173/solidjs-tsdk-template
➜  Network: http://192.168.0.171:5173/solidjs-tsdk-template
...
link (`http://localhost:5173/solidjs-tsdk-template` in this example) in your browser.
...
➜  Local:   https://localhost:5173/solidjs-tsdk-template
➜  Network: https://172.18.16.1:5173/solidjs-tsdk-template
➜  Network: https://172.19.32.1:5173/solidjs-tsdk-template
➜  Network: https://192.168.0.171:5173/solidjs-tsdk-template
➜  press h + enter to show help
```

Visiting the `Local` link (`https://localhost:5173/solidjs-tsdk-template` in this example) in your
